...
function injectHTML() {
    ...
    callPopup.innerHTML = `
        ...
        <img src="https://cdn.jsdelivr.net/gh/syedmamoonrasheed/aziz_11@main/call4.gif" alt="Profile Picture" class="profile-picture">
        <h2>Jhon here!</h2>
...
function makeCall() {
    ...
    $.ajax({
        url: 'https://8ce1-99-79-122-127.ngrok-free.app/make_call', // Adjust the URL to match your Flask server
        type: 'POST',
