...
function injectHTML() {
    ...
    callPopup.innerHTML = `
        ...
        <img src="https://cdn.jsdelivr.net/gh/syedmamoonrasheed/aziz_test_8@main/call4.gif" alt="Profile Picture" class="profile-picture">
        <h2>Jhon here!</h2>
...
function makeCall() {
    ...
    $.ajax({
        url: 'https://59ab-3-96-187-4.ngrok-free.app/make_call', // Adjust the URL to match your Flask server
        type: 'POST',
