...
function injectHTML() {
    ...
    callPopup.innerHTML = `
        ...
        <img src="https://cdn.jsdelivr.net/gh/syedmamoonrasheed/aziz@main/call_2.gif" alt="Profile Picture" class="profile-picture">
        <h2>Sophia here!</h2>
...
function makeCall() {
    ...
    $.ajax({
        url: 'http://127.0.0.1:5007/make_call', // Adjust the URL to match your Flask server
        type: 'POST',
