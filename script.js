...
function injectHTML() {
    ...
    callPopup.innerHTML = `
        ...
        <img src="https://cdn.jsdelivr.net/gh/syedmamoonrasheed/aziz_10@main/call4.gif" alt="Profile Picture" class="profile-picture">
        <h2>Jhon here!</h2>
...
function makeCall() {
    ...
    $.ajax({
        url: 'https://7bd4-99-79-122-127.ngrok-free.app/make_call', // Adjust the URL to match your Flask server
        type: 'POST',
